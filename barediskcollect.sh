...
#[root@client0 log0]# cat 1|grep device -A 10|grep -w latency|head -n1
#[root@client0 log0]# cat 1|grep device -A 10|grep -w lat|head -n1
#cat 1|grep device -A 10|grep iops|head 1
